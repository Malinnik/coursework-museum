...
const AuthPage = () => {
	...
	async function createUser() {
		setResult( await register({username, password, fullname}));
	}

	async function log_in_system() {
		setResult(await login({username, password, fullname}))
	}
	...
	return (
		<div className="h-full w-full bg-slate-100">
			...
			<div className=" rounded-md bg-slate-400 border-black border-2 p-2 pl-10 pr-10">
				...
				<p className="mt-5">fullname: <input type="text" onChange={e => setFullname(e.target.value)}/></p>
